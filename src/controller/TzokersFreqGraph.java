// Υποκλάση που δημιουργεί γράφημα για τις συχνότητες εμφάνισης των αριθμών τζόκερ
...
public class TzokersFreqGraph extends Graph {

    public TzokersFreqGraph() {
        super("Συχνότητα τζοκερς (5 πρώτοι)", "Εμφανίσεις", "Αριθμοί");
    }
    ...
    public Map<Integer, Long> getData() {
        ...
        for (int i = 1; i <= 20; i++) {
            numbers.put(i, (long) Utils.countOccurrences(numbersInDB, Integer.toString(i), '2'));
        }
